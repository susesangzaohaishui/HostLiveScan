...
static host::mutex_t compatible_get_tick_count64_mutex;

ULONGLONG compatible_get_tick_count64()
{
  compatible_get_tick_count64_mutex.lock();
  static unsigned int s_wrap = 0;
  static unsigned int s_last_tick = 0;
  const unsigned int current_tick = ::GetTickCount();
