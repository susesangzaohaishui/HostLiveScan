...
#define NET_SIGNALER_WAIT_BASED_ON_SELECT
#elif defined NET_FORCE_POLL
#define NET_SIGNALER_WAIT_BASED_ON_POLL
#elif defined NET_HAVE_LINUX || defined NET_HAVE_FREEBSD ||\
    defined NET_HAVE_OPENBSD || defined NET_HAVE_SOLARIS ||\
    defined NET_HAVE_OSX || defined NET_HAVE_QNXNTO ||\
    defined NET_HAVE_HPUX || defined NET_HAVE_AIX ||\
    defined NET_HAVE_NETBSD
#define NET_SIGNALER_WAIT_BASED_ON_POLL
#elif defined NET_HAVE_WINDOWS || defined NET_HAVE_OPENVMS ||\
	defined NET_HAVE_CYGWIN
#define NET_SIGNALER_WAIT_BASED_ON_SELECT
#endif
...
#include <poll.h>
#elif defined NET_SIGNALER_WAIT_BASED_ON_SELECT
...
host::fd_t host::signaler_t::get_fd ()
{
    return r;
}

void host::signaler_t::send ()
{
#if HAVE_FORK
...
int host::signaler_t::wait (int timeout_)
{
#ifdef HAVE_FORK
    if (unlikely(pid != getpid()))
    {
...
#ifdef NET_SIGNALER_WAIT_BASED_ON_POLL
...
int host::signaler_t::make_fdpair (fd_t *r_, fd_t *w_)
{
#if defined NET_HAVE_EVENTFD
    fd_t fd = eventfd (0, 0);
    if (fd == -1) {
...
#   endif
    ...
    *w_ = open_socket (AF_INET, SOCK_STREAM, 0);
    ...
    unsigned int dwrc = WaitForSingleObject (sync, INFINITE);
    net_assert (dwrc == WAIT_OBJECT_0);
