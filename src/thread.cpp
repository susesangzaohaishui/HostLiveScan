...
extern "C"
{
	...
	static unsigned int thread_routine (LPVOID arg_)
#else
    static unsigned int __stdcall thread_routine (void *arg_)
#endif
    {
        host::thread_t *self = (host::thread_t*) arg_;
        self->tfn (self->arg);
        return 0;
    }
}

void host::thread_t::start (thread_fn *tfn_, void *arg_)
{
    tfn = tfn_;
    arg =arg_;
#if defined _WIN32_WCE
...
void host::thread_t::stop ()
{
    unsigned int rc = WaitForSingleObject (descriptor, INFINITE);
...
extern "C"
{
    ...
    {
#if !defined NET_HAVE_OPENVMS && !defined NET_HAVE_ANDROID
